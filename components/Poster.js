...
function Poster({ track, chooseTrack }) {
  ...
  return (
    <div
      className="w-[260px] h-[360px] rounded-[50px] overflow-hidden relative text-white/80 cursor-pointer hover:scale-105 hover:text-white/100 transition duration-200 ease-out groupmx-auto"
      onClick={handlePlay}
    >
      <img
        src={track.albumUrl}
      ...
      <div className="absolute bottom-10 inset-x-0 ml-4 flex items-center space-x-3.5">
        <div className="h-10 w-10 bg-[#cb5050] rounded-full flex items-center justify-center group-hover:bg-[#c73b3b] flex-shrink-0">
